    ...
    return (
        <form className={styles.loginForm} onSubmit={(e) => e.preventDefault()}>
            ...
            <div className={styles.loginOptions}>
                <div >
                    <Checkbox label='Remember me' onChange={setRememberMeChecked} checked={RememberMeChecked} />
                </div>
                <span className={styles.link}> <Button label='Forgot password?' onClick={() => { toggleForm('forgetPassword') }} noAppearance={true} size='small' /></span>
            </div>
            ...
            <div className={styles.registerOption}>
                <span>Don't have an account?</span><span className={styles.link}><Button onClick={() => { toggleForm('register') }} label='Register' noAppearance={true} size='small' /></span>
            </div>
        </form >
    );
};
