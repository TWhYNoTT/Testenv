...
interface ServiceCardProps {
    ...
    onDelete?: (serviceId: number) => void; // Changed to pass serviceId
}

const ServiceCard: React.FC<ServiceCardProps> = ({
    id, title, category, duration, branch, image, pricingOptions, onEdit, onDelete
}) => {
    ...
    const handleDelete = () => {
        setDropdownVisible(false);
        onDelete?.(id); // Just call the callback with service ID
    };
